...
# Version 1.0: Initial release
  * Added constructor
  * Normalization
### Version 1.0.1: Basic arithmetic
  * Addition       `plus()`
  * Subtraction    `minus()`
...
## Version 1.1: Math functions
  ...
  * Log base-10    `log10()`
  * Exponents      `pow()`
### Version 1.1.1: Cloning and Negating
  * Clone          `__copy__()`
  * Negate         `__negate()`
...
### Version 1.1.3: Integer rounding
  * Floor          `floor()`
  * Ceiling        `ceil()`
  * Trunc          `trunc()`
  * Modulo         `mod()`
## Version 1.2: Trigonometry
  ...
  * Cosine         `cos()`
  * Tangent        `tan()`
### Version 1.2.1: Absolute and the Inverse Trigonometry
  * Absolute value `abs()`
  * Inverse sine   `asin()`
  * Inverse cosine `acos()`
...
### Version 1.2.2: More logx
  * Log base-2     `log2()`
## Version 1.3: Hyperbolic functions
  * Hyperbole sine `sinh()`
  * Hyperbole cos  `cosh()`
  * Hyperbole tan  `tanh()`
